...
description: Learn to build powerful AI systems by understanding the trade-offs
  between reliable workflows and flexible agents, and implementing key agentic
  patterns with Genkit.
supportedLanguages:
  - js
  - go
  - dart
