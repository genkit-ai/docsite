...
See the [Consuming remote models section in the Models guide](/docs/dart/models/#consuming-remote-models) for details on pointing Genkit at these endpoints, and the [Serving Models section in the Shelf guide](/docs/frameworks/shelf#serving-models) for how to expose the model securely on your server.
