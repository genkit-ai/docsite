...
Flask integration is not applicable to JavaScript. See the [Express integration guide](/docs/frameworks/flask) instead.
:::
...
Flask integration is not applicable to Go.
:::
...
- See [deployment guides](/docs/deployment) for Go-specific examples
