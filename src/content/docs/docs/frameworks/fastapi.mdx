...
description: Learn how to integrate Genkit with FastAPI applications for Python,
  including REST API endpoints, streaming responses, and deployment strategies.
supportedLanguages:
  - python
---
