...
3. Open the Developer UI (typically at `http://localhost:4000`) to view traces.
...
There is no Firebase Genkit Monitoring plugin for Dart. For production
observability, use `genkit_otel` to export traces, metrics, and logs to any
