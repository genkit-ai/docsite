...
dashboard helps you understand the overall health of your Genkit features. It
is also useful for debugging stability and content issues that may
indicate problems with your prompts and/or flows. See the
[Getting Started](/docs/observability/getting-started) guide for
setup instructions.
...
Alternatively, you can export OpenTelemetry data from Genkit Python to
third-party backends (for example Sentry, Honeycomb, Datadog, Grafana Cloud, or
Axiom) via OTLP. See
[Third-party observability (OTLP export)](/docs/observability/third-party-observability)
for details.
