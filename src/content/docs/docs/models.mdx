...
<ExampleLink title="Structured Output" description="View a live example of using structured output to generate a D&D character sheet." example="structured-output" />
...
<ExampleLink title="Image Analysis" description="See a live demo of how Genkit can enable image analysis using multimodal input." example="image-analysis"/>
