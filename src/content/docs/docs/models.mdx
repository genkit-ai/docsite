...
When you serve a model as an HTTP endpoint (for example, using [Shelf](/guides/frameworks/shelf#serving-models) or [Express](/guides/frameworks/express#serving-models)), you can consume it from another Genkit application using `defineRemoteModel`:
