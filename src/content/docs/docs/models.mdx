...
Genkit supports many AI providers including Google AI, OpenAI, Anthropic, xAI, DeepSeek, and Ollama. See the [AI Provider Overview](/docs/plugins/overview) for a complete list of officially supported and community providers across all languages.

### Setup

Before using `generate()`, you need to configure an AI provider plugin. See the [Getting Started guide](/docs/get-started) for setup instructions.
