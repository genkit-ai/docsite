...
When you serve a model as an HTTP endpoint (for example, using [Shelf](/docs/frameworks/shelf#serving-models) or [Express](/docs/frameworks/express#serving-models)), you can consume it from another Genkit application using `defineRemoteModel`:
