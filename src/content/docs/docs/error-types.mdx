...
<LanguageContent lang="go">
  :::note[Guidance unavailable for Go] Error type guidance is not yet available for Go. :::
</LanguageContent>

<LanguageContent lang="python">
  :::note[Guidance unavailable for Python] Error type guidance is not yet available for Python. :::
</LanguageContent>
