...
<video
  ...
  aria-label="Preview of the Bargain Chef app that you will build in this Angular tutorial"
>
  ...
  Chef app that you will build in this Angular tutorial.
</video>

You can find the [finished code on GitHub](https://github.com/genkit-ai/samples/tree/main/quickstarts/app-frameworks/angular).
...
<Aside type="note" title="Already have a standalone Genkit backend?">
  Follow this tutorial for the Angular UI structure, but point{' '}
  <code>streamFlow</code> at your existing backend route instead of the SSR
  route. See{' '}
