...
export const corsCallout = (
  <Aside type="caution" title="Enable CORS on the backend">
    Your SvelteKit dev server runs on <code>http://localhost:5173</code> and
    ...
    configured CORS on your backend yet, do that before running the SvelteKit
    app. See your backend framework's CORS documentation for the exact
    configuration.
  </Aside>
);
...
<video
  ...
  aria-label="Preview of the Bargain Chef app that you will build in this SvelteKit tutorial"
>
  ...
  Chef app that you will build in this SvelteKit tutorial.
</video>

<Lang lang="js">

You can find the [finished code on GitHub](https://github.com/genkit-ai/samples/tree/main/quickstarts/app-frameworks/sveltekit/ssr).
...
<Aside type="note" title="Already have a standalone Genkit backend?">
  Follow this tutorial for the SvelteKit UI structure, but point{' '}
  <code>streamFlow</code> at your existing backend route instead of the
  SvelteKit endpoint. See{' '}
...
You can find the [finished code on GitHub](https://github.com/genkit-ai/samples/tree/main/quickstarts/app-frameworks/sveltekit/standalone).
