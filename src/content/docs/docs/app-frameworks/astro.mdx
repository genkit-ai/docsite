...
<video
  ...
  aria-label="Preview of the Bargain Chef app that you will build in this Astro tutorial"
>
  ...
  Chef app that you will build in this Astro tutorial.
</video>

You can find the [finished code on GitHub](https://github.com/genkit-ai/samples/tree/main/quickstarts/app-frameworks/astro).
...
<Aside type="note" title="Already have a standalone Genkit backend?">
  Follow this tutorial for the Astro UI structure, but point{' '}
