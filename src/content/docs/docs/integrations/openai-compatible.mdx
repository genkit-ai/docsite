...
description: Learn how to configure and use Genkit OpenAI-compatible plugin to
  access models through any OpenAI-compatible API across JavaScript, Python, and
  Go.
supportedLanguages:
  - js
  - go
