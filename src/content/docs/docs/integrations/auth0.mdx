...
description: Learn how to use the Auth0 AI plugin for Genkit to build secure
  AI-powered applications with authentication, authorization, and fine-grained
  access control using Auth0 and Okta FGA.
supportedLanguages:
  - js
---
