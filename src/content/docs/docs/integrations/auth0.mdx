...
<LanguageContent lang="go">
  :::note[Feature unavailable for Go] The Auth0 AI plugin is not yet available for Go. :::
</LanguageContent>

<LanguageContent lang="python">
  :::note[Feature unavailable for Python] The Auth0 AI plugin is not yet available for Python. :::
</LanguageContent>
