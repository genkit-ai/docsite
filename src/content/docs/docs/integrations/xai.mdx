---
title: xAI Plugin
description: Learn how to configure and use Genkit xAI plugin to access xAI (Grok) models in JavaScript.
---
...
<LanguageContent lang="go">
  :::note[Feature unavailable for Go] The xAI plugin has not yet been made available for Go. :::
</LanguageContent>

<LanguageContent lang="python">
  :::note[Feature unavailable for Python] The xAI plugin has not yet been made available for Python. :::
</LanguageContent>
