...
The OpenAI-compatible plugin (`compat_oai`) can be configured to access [xAI (Grok)](https://x.ai/) models.
This provides access to the `grok` family of models, including `grok-image` for image generation.
...
import (
  ...
  "github.com/genkit-ai/genkit/go/plugins/compat_oai"
)
