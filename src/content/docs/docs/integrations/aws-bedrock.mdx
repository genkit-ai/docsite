...
:::note
`genkit-amazon-bedrock` is not on PyPI yet. Until the first release ships, install it straight from the Genkit repository:

```bash
uv add "genkit-amazon-bedrock @ git+https://github.com/genkit-ai/genkit#subdirectory=py/packages/genkit-amazon-bedrock"
```
:::
