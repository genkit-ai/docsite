...
description: Learn how to configure and use the AWS Bedrock plugin for Genkit to
  interact with AWS Bedrock and embedding models across JavaScript, Go, and
  Python.
supportedLanguages:
  - js
  - go
