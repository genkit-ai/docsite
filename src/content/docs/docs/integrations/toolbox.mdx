...
description: Learn how to use the MCP Toolbox for Databases with Genkit to build
  enterprise-grade database tools with connection pooling, authentication, and
  security features.
supportedLanguages:
  - js
  - go
