...
<LanguageContent lang="go">
  :::note[Feature unavailable for Go] The DeepSeek plugin has not yet been made available for Go. :::
</LanguageContent>

<LanguageContent lang="python">
  :::note[Feature unavailable for Python] The DeepSeek plugin has not yet been made available for Python. :::
</LanguageContent>
