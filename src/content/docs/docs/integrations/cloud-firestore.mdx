...
```go
import "github.com/genkit-ai/genkit/go/plugins/firebase"
```
...
import (
	...
	"github.com/genkit-ai/genkit/go/plugins/firebase"
	"github.com/genkit-ai/genkit/go/plugins/compat_oai/openai"
)
