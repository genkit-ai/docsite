...
description: Learn how to use Google's Generative AI models across JavaScript,
  Go, and Python through the Gemini Developer API, including text generation,
  embeddings, image generation, video generation, and text-to-speech.
supportedLanguages:
  - js
  - go
  - dart
