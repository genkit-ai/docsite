...
description: Learn how to configure and use the Azure Foundry plugin for Genkit
  to interact with Azure Foundry and embedding models across JavaScript, Go, and
  Python.
supportedLanguages:
  - js
  - go
