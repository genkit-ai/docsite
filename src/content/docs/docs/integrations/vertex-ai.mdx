...
:::tip[Getting Started]
For simple API key access to Google's AI models, start with the [Google AI plugin](/docs/plugins/google-ai). This page covers enterprise features available through Vertex AI.
:::
...
- For simple API key access, see the [Google AI plugin](/docs/plugins/google-ai)
