...
The plugin requires you to specify your Google Cloud project ID, the [region](https://docs.cloud.google.com/gemini-enterprise-agent-platform/resources/locations) to which you want to make Vertex API requests, and your Google Cloud project credentials.
...
**Core Vertex AI features** (included in `genkit-googleai`):
...
```python
from genkit import Genkit
from genkit_vertex_ai import ModelGardenPlugin
from genkit_vertex_ai.model_garden import model_garden_name
