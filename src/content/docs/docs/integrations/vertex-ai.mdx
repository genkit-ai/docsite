...
For the full list of available Claude models see: [Available Claude models](https://cloud.google.com/vertex-ai/generative-ai/docs/partner-models/claude)
...
For the full list of available Llama models see: [Fully-managed Llama models](https://cloud.google.com/vertex-ai/generative-ai/docs/partner-models/llama)
...
For the full list of available Mistral AI models see: [Mistral AI models](https://cloud.google.com/vertex-ai/generative-ai/docs/partner-models/mistral)
...
The usual setup is a Google Cloud project ID, the [region](https://cloud.google.com/vertex-ai/generative-ai/docs/learn/locations) you want to send Gemini Enterprise API requests to, and Application Default Credentials.
