...
Anthropic automatically caches content based on the `cache_control` metadata. You can cache system prompts, user messages, images, documents, etc.

#### Basic Usage

Enable prompt caching in a system prompt:
