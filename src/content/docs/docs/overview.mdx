...
|                               |                                                                                                                                                                                                                                                                                                                                                                        |
| :---------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Broad AI model support**    | Use a unified interface to integrate with hundreds of models from providers like [Google](/docs/plugins/google-genai), [OpenAI](/docs/plugins/openai), [Anthropic](https://github.com/BloomLabsInc/genkit-plugins/blob/main/plugins/anthropic/README.md), [Ollama](/docs/plugins/ollama), and more. Explore, compare, and use the best models for your needs.          |
