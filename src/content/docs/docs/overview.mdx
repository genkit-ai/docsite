...
| [basic-middleware/a2ui](https://github.com/genkit-ai/genkit/tree/main/go/samples/basic-middleware/a2ui) | An agent that streams interactive UI to a browser through the A2UI middleware, served at the endpoint the JavaScript client expects. Runs on an in-preview API. |
