...
<Aside type="tip" title="Genkit Go is now 1.0!">
  Check out our announcement on the [Google for Developers
  blog](https://developers.googleblog.com/en/announcing-genkit-go-10-and-enhanced-ai-assisted-development/).
</Aside>
