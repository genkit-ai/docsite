...
|       |                                         |                                                                                                                                                                                                                                                                                                                  |
| :---- | :-------------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **1** | Choose your language and model provider | Select the Genkit SDK for your preferred language (JavaScript/TypeScript, Go, or Python). Choose a model provider like [Google Gemini](/docs/integrations/google-genai) or Anthropic, and get an API key. Some providers, like [Vertex AI](/docs/integrations/vertex-ai), may rely on a different means of authentication. |
