...
You should be familiar with Genkit's concept of [flows](/guides/flows), and how to write them.
...
Install the Genkit dependencies into your Angular app, the same way you would for any Genkit project:
...
5. If you didn't install the Genkit CLI globally, you can install it as a development dependency. The tsx tool is also recommended, as it makes testing your code more convenient. Both of these dependencies are optional, however.
...
Create a new file in your Angular project to contain your Genkit flows: for example, `src/genkit.ts`. This file can contain your flows without modification.
...
For example, you can replace the contents of `src/app/app.component.ts` with the following:
...
- [Cloud Functions for Firebase](/deployment/firebase)
- [Cloud Run](/deployment/cloud-run)
- [Other Node.js platforms](/deployment/deploy-node)
