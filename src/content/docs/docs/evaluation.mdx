...
func NewFoodEvaluator(r api.Registry, judgeLLM ai.Model) ai.Evaluator {
	return ai.DefineEvaluator(r, api.NewName("custom", "foodEvaluator"),
		&ai.EvaluatorOptions{
			DisplayName: "Food Evaluator",
			Definition:  "Determines if an output is a delicious food item.",
		},
...
<LanguageContent lang="python">
	:::note[Feature documentation unavailable for Python] Documentation is currently unavailable for Python. Stay tuned.
	:::
</LanguageContent>
