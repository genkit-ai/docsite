...
<LanguageContent lang="go">
  :::note[Feature unavailable for Go] Interrupts are not yet available for Go. :::
</LanguageContent>

<LanguageContent lang="python">
  :::note[Feature unavailable for Python] Interrupts are not yet available for Python. :::
</LanguageContent>
