...
Interrupts are not yet available for Go.
:::
</LanguageContent>

<LanguageContent lang="python">

_Interrupts_ are a special kind of [tool](/docs/tools/) that can pause the
...
- General methods of [tool-calling](/docs/tools/).
