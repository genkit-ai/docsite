...
Guidance for writing custom evaluator plugins is not yet available for Python.
:::
</LanguageContent>

<LanguageContent lang="go">
  :::note[Unavailable for Go]
Guidance for writing custom evaluator plugins is not yet available for Go.
:::
</LanguageContent>
