...
- Learn about writing embedder plugins for text embedding models
- Explore writing retriever plugins for custom data sources
- See telemetry plugins for monitoring and observability
- Check out the [plugin authoring overview](/docs/plugin-authoring/overview) for general plugin concepts
