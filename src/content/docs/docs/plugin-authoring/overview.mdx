...
import (
    ...
    "[github.com/firebase/genkit/go/ai](https://github.com/genkit-ai/genkit/go/ai)"
    "[github.com/firebase/genkit/go/genkit](https://github.com/genkit-ai/genkit/go/genkit)"
    "[github.com/firebase/genkit/go/plugins/googlegenai](https://github.com/genkit-ai/genkit/go/plugins/googlegenai)"
    "[github.com/firebase/genkit/go/plugins/server](https://github.com/genkit-ai/genkit/go/plugins/server)"
)
```
