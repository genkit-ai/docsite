...
This page covers defining the agent itself. For when to choose an agent over a plain flow, see [Full-stack agents](/docs/agents).
...
Use `genkit.DefineAgent` for most prompt-backed agents. It keeps inline prompt configuration beside the agent wiring.
