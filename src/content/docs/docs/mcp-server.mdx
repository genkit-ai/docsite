...
You can use the `get_usage_guide` tool to a usage guide for the Genkit AI framework. You can specify a language for the guide. The usage guide includes best practices and recommended project structure and plugins to use. This tool is intended to be used by AI assistants to understand building Genkit apps.

**Example:**
To get the usage guide for JavaScript:
