...
<LanguageContent lang="go">
  :::note[Feature unavailable for Go] This feature has not yet been made avaialble for Go. :::
</LanguageContent>

<LanguageContent lang="python">
  :::note[Feature unavailable for Python] This feature has not yet been made avaialble for Python. :::
</LanguageContent>
