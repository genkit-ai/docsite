...
final searchNotes = ai.defineTool(
  ...
  outputSchema: listSchema(UserNote.$schema),
  fn: (query, ctx) async {
...
<LanguageContent lang="go">
  ...
  Documentation for this feature has not yet been made avaialble for Go. Stay tuned.
  :::
</LanguageContent>

<LanguageContent lang="python">
  :::note[Feature unavailable for Python]
  Documentation for this feature has not yet been made avaialble for Python. Stay tuned.
  :::
</LanguageContent>
