...
description: Learn how Genkit's context object propagates generation and
  execution information throughout your application, making it available to
  flows, tools, and prompts across different languages.
supportedLanguages:
  - js
  - dart
---
