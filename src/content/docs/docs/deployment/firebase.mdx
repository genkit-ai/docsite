...
Firebase deployment is not yet available for Go. Please use JavaScript for Firebase deployment functionality.
:::
...
Firebase deployment is not yet available for Python. Please use JavaScript for Firebase deployment functionality.
:::
