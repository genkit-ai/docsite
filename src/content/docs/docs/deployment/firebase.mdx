...
Firebase deployment is not yet available for Go. For deployment on Google Cloud, see the [Cloud Run deployment guide](/docs/deployment/cloud-run).
:::
...
Firebase deployment is not yet available for Genkit Python. For deployment on Google Cloud, see the [Cloud Run deployment guide](/docs/deployment/cloud-run).
:::
      ...
      <body>
        ...
        <script type="module">
          ...
          async function generatePoem() {
            ...
            document.querySelector("#generatedPoem").innerText =
              response.data.poem;
          }
