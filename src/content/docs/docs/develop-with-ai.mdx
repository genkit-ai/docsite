...
Genkit supports two ways of integrating with Gemini CLI:
 ...
 - `GEMINI.md` file: You can use the `init:ai-tools` command to set up Genkit context using a `.md` file. This will add a new section to your GEMINI.md file with Genkit context. This works at the workspace level, providing project-level support. 

{/* TODO: Update link to extension repo */}
 - Gemini CLI extension: Genkit has an official [Gemini CLI extension](https://github.com/google-gemini/gemini-cli/blob/main/docs/extension.md) that can be installed using the Gemini CLI:

    ```bash
    gemini extensions install https://github.com/google-gemini/genkit
    ``` 
