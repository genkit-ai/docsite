...
<LanguageContent lang="go">
  ```bash # Install Google Cloud plugin go get github.com/firebase/genkit/go/plugins/googlecloud ```
</LanguageContent>

<LanguageContent lang="python">
  ```bash # Install monitoring dependencies pip install genkit[monitoring] ```
</LanguageContent>
...
- Learn about [authentication and setup](/docs/observability/authentication) for production monitoring
- Explore [advanced configuration](/docs/observability/advanced-configuration) options
- Check out [troubleshooting](/docs/observability/troubleshooting) common issues
- Read the main [observability and monitoring](/docs/observability-monitoring) guide for detailed implementation
