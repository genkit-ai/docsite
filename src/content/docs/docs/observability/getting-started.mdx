...
3. Write a Genkit feature by following the [Get Started Guide](/docs/get-started), and prepare your code for deployment by using one of the following guides:
   ...
   <Lang lang="js">
     a. [Deploy flows using Cloud Functions for
     Firebase](/docs/deployment/firebase) b. [Deploy flows using Cloud
     Run](/docs/deployment/cloud-run) c. [Deploy flows to any Node.js
     platform](/docs/deployment/any-platform)
   </Lang>
