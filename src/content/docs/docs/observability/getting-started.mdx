...
3. Write a Genkit feature by following the [Get Started Guide](/docs/get-started), and prepare your code for deployment by using one of the following guides:
   ...
   a. [Deploy flows using Cloud Functions for Firebase](/guides/deployment/firebase)
   b. [Deploy flows using Cloud Run](/guides/deployment/cloud-run)
   c. [Deploy flows to any Node.js platform](/guides/deployment/any-platform)

   </Lang>

   <Lang lang="go">

   a. [Deploy flows using Cloud Run](/guides/deployment/cloud-run)
