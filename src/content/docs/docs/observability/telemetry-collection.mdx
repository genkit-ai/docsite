...
| Field name | Description                                                                                                                                            |
| ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ |
| message    | `[genkit] Input[<path>, <featureName>]` (or `[genkit] Input[<path>, <model>]` for model interactions), including `(part X of Y)` for multi-part messages |
...
| Field name | Description                                                                                                                                             |
| ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------- |
| message    | `[genkit] Output[<path>, <featureName>]` (or `[genkit] Output[<path>, <model>]` for model interactions), including `(part X of Y)` for multi-part messages |
| metadata   | Additional context including the input message sent to the action                                                                                       |
