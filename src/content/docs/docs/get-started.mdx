...
description: Learn how to get started with Genkit, including project setup, installing packages, configuring API keys, creating your first flow, and testing in the Developer UI.
supportedLanguages:
  - js
  - go
  - dart
...
<Lang lang="dart">
- Dart SDK 3.10.0 or later ([Download and install](https://dart.dev/get-dart))
</Lang>
...
```dart title="bin/my_genkit_app.dart"
import 'dart:convert';
...
1. Select your recipe generator flow from the list of flows:
   ...
   <Lang lang="js go">- `recipeGeneratorFlow`</Lang>
   <Lang lang="python">- `recipe_generator_flow`</Lang>
   <Lang lang="dart">- `recipeGeneratorFlow`</Lang>
...
>
  ...
  run a Genkit flow in the Developer UI, showing the recipe generator flow with
