...
<LanguageContent lang="go python dart">
...
- Defines reusable input and output schemas using `@Schematic` annotation
...
1. Select your recipe generator flow from the list of flows:
   ...
   <LanguageContent lang="dart">- `recipeGeneratorFlow`</LanguageContent>
