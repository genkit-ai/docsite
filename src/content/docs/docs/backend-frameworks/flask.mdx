...
This tutorial uses the Gemini API from Google AI Studio. Get a key at [aistudio.google.com/apikey](https://aistudio.google.com/apikey), then set the `GEMINI_API_KEY` environment variable:
