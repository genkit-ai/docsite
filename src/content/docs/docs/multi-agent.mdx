...
description: Learn how to build multi-agent systems in Genkit by delegating
  tasks to specialized agents, addressing challenges of complex agentic
  workflows.
supportedLanguages:
  - js
---
...
Multi-agent systems primitives are not yet available for Go.
:::
</Lang>

<Lang lang="python">
  :::note[Feature unavailable for Python]
Multi-agent systems primitives are not yet available for Python.
:::
</Lang>
