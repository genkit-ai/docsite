...
<LanguageContent lang="go">
  :::note[Feature unavailable for Go] Multi-agent systems primitives are not yet available for Go. :::
</LanguageContent>

<LanguageContent lang="python">
  :::note[Feature unavailable for Python] Multi-agent systems primitives are not yet available for Python. :::
</LanguageContent>
