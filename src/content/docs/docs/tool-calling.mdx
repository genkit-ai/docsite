...
docstring; the input schema comes from the type hints. Choose a clear function
name and write a descriptive docstring—they're what the model uses to decide
