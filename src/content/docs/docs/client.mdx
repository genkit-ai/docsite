...
## 1. Using the Genkit client library
...
## 2. When deploying to Cloud Functions for Firebase

When deploying to Cloud Functions for Firebase, use the Firebase callable functions client library. Documentation can be found at https://firebase.google.com/docs/functions/callable?gen=2nd
