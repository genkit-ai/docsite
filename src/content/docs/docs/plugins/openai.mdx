...
- Explore [tool calling](/docs/tool-calling) to integrate OpenAI's function calling capabilities
- See [creating flows](/docs/flows) to build structured AI workflows
- Check out [RAG](/docs/rag) to implement retrieval-augmented generation with OpenAI embeddings
