...
- Learn about [authorization patterns](/docs/deployment/authorization) for additional security options
- Explore [tool calling](/docs/tool-calling) to understand how tools work in Genkit
- Check out [interrupts](/docs/interrupts) for handling user interactions in flows
- See [RAG](/docs/rag) for building retrieval-augmented generation applications
</LanguageContent>
...
See the [authorization patterns](/docs/deployment/authorization) guide for language-agnostic security approaches.
</LanguageContent>