...
:::note
Tools are not supported on Claude models via the OpenAI API. Use Claude models for reasoning and analysis tasks, and OpenAI models for tool-calling scenarios.
:::
