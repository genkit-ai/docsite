...
description: Learn how to configure and use Genkit OpenAI-compatible plugin to access models through any OpenAI-compatible API across JavaScript and Go.
---
...
The OpenAI-Compatible plugin has not yet been made available for Python.
:::
</LanguageContent>
...
- [**OpenAI Plugin**](/docs/plugins/openai): Direct access to OpenAI's models and embeddings
- [**Anthropic Plugin**](/docs/plugins/anthrpic): Access to Claude models through OpenAI-compatible endpoints
