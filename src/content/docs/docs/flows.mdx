...
You can define schemas using the `@Schematic` annotation from the `schemantic` package. This generates Dart classes with JSON serialization and schema definitions.
