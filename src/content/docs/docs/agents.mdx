...
- [Serve over HTTP](/docs/agents/http) covers Express routes, `remoteAgent()`, the JavaScript and Dart clients, and a React integration through the Vercel AI SDK.
...
- [Serve over HTTP](/docs/agents/http) covers Go routes, curl examples, the JavaScript and Dart clients, and a React integration through the Vercel AI SDK.
