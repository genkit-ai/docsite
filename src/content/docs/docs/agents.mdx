...
- [Serve over HTTP](/docs/agents/http) covers Express routes, `remoteAgent()`, the JavaScript and Dart clients, and a Vercel AI SDK integration.
...
- [Serve over HTTP](/docs/agents/http) covers Go routes, curl examples, the JavaScript and Dart clients, and a Vercel AI SDK integration.
