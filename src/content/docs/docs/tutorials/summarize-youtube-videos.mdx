...
:::note
This tutorial uses Gemini's multimodal capabilities to process video content. Other providers may have different multimodal support. See [AI providers](/docs/plugins/overview) for more options.
:::
...
- Learn about [generating content](/docs/models) for more multimodal capabilities
- Explore [creating flows](/docs/flows) to build more complex video processing pipelines
- Try [different AI providers](/docs/plugins/overview) that support multimodal inputs
- Build a web interface using [framework integrations](/docs/frameworks/express)
- Combine with [RAG](/docs/rag) to create a knowledge base from video content
