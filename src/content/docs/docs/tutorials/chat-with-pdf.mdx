...
<LanguageContent lang="go">
  :::note[Tutorial unavailable for Go] This tutorial has not yet been made avaialble for Go. :::
</LanguageContent>

<LanguageContent lang="python">
  :::note[Tutorial unavailable for Python] This tutorial has not yet been made avaialble for Python. :::
</LanguageContent>
...
- [Gemini from Vertex AI.](/docs/integrations/vertex-ai#usage)
- Anthropic's Claude 3 models and Llama 3.1 through the
  [Vertex AI Model Garden](/docs/integrations/vertex-ai#model-garden-integration),
