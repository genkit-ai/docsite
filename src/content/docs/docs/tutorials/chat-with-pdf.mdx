...
- [Gemini from Vertex AI.](docs/integrations/vertex-ai#generative-ai-models)
- Anthropic's Claude 3 models and Llama 3.1 through the
  [Vertex AI Model Garden](docs/integrations/vertex-ai#anthropic-claude-3-on-vertex-ai-model-garden),
