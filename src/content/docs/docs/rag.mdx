...
- [Vector Search in Gemini Enterprise](/docs/integrations/vertex-ai)
...
This reranker uses the Gemini Enterprise Genkit plugin (`vertexai`) with `semantic-ranker-512` to
...
| [Vector Search with BigQuery](/docs/integrations/vectorsearch-bigquery) | Your corpus is in BigQuery and you want Vector Search in Gemini Enterprise to serve the index. |
| [Vector Search with Firestore](/docs/integrations/vectorsearch-firestore) | Same, with Firestore as the document store.                                    |
...
| [Gemini Enterprise](/docs/integrations/vertex-ai)       | `vertexai/text-embedding-004`, `vertexai/text-embedding-005` and others. |
...
This walkthrough registers the [Gemini Enterprise plugin](/docs/integrations/vertex-ai) (`&googlegenai.VertexAI{}`),
...
func main() {
	...
	// Initialize Genkit with the Gemini Enterprise plugin.
