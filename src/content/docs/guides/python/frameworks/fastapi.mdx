---
title: FastAPI
description: Start from a FastAPI app and expose the same recipe flow from the
  main quickstart as an HTTP endpoint.
supportedLanguages:
  - python
---

{/* AUTO-GENERATED FILE - DO NOT EDIT DIRECTLY. Edit the source document instead: src/content/docs/guides/frameworks/fastapi.mdx Then run: pnpm generate-language-pages */}
