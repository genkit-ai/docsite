...
import LLMs from "../../../components/llms.astro";
...
const MenuItemSchema = z.object({
  ...
  calories: z.coerce.number().describe("Calories"), // Use coerce for flexibility
  allergens: z.array(z.string()).describe("Allergens"),
});
...
```typescript
import { imagen3 } from "@genkit-ai/vertexai"; // Example image model
