---
title: Gin
description: Start from a Gin server and expose the same recipe flow from the
  main quickstart as an HTTP API.
supportedLanguages:
  - go
---

{/* AUTO-GENERATED FILE - DO NOT EDIT DIRECTLY. Edit the source document instead: src/content/docs/guides/frameworks/gin.mdx Then run: pnpm generate-language-pages */}
