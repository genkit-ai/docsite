---
title: Chi
description: Start from a Chi router and expose the same recipe flow from the
  main quickstart as an HTTP API.
supportedLanguages:
  - go
---

{/* AUTO-GENERATED FILE - DO NOT EDIT DIRECTLY. Edit the source document instead: src/content/docs/guides/frameworks/chi.mdx Then run: pnpm generate-language-pages */}
