---
title: Angular
description: Start from an Angular app and add the same recipe flow from the
  main quickstart with an SSR server route and frontend call.
supportedLanguages:
  - js
---

{/* AUTO-GENERATED FILE - DO NOT EDIT DIRECTLY. Edit the source document instead: src/content/docs/guides/frameworks/angular.mdx Then run: pnpm generate-language-pages */}
...
import { recipeGeneratorFlow } from '../../frameworks/genkit/recipeGeneratorFlow';
```
