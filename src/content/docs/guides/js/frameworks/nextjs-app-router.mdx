...
description: Start from a Next.js App Router app and add the same recipe flow
  from the main quickstart using Genkit route handlers.
supportedLanguages:
  - js
---

{/* AUTO-GENERATED FILE - DO NOT EDIT DIRECTLY. Edit the source document instead: src/content/docs/guides/frameworks/nextjs-app-router.mdx Then run: pnpm generate-language-pages */}

import { FileTree } from '@astrojs/starlight/components';

Use this guide when you're starting from a Next.js App Router app and want the fastest path to a working Genkit integration.
