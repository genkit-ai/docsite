---
title: Fastify
description: Start from a Fastify server and expose the same recipe flow from
  the main quickstart using the fetch plugin.
supportedLanguages:
  - js
---

{/* AUTO-GENERATED FILE - DO NOT EDIT DIRECTLY. Edit the source document instead: src/content/docs/guides/frameworks/fastify.mdx Then run: pnpm generate-language-pages */}
