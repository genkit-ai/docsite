...
description: Learn how to deploy Genkit Flows as Azure Functions HTTP triggers
  using the Azure AI Foundry plugin.
supportedLanguages:
  - js
---

{/* AUTO-GENERATED FILE - DO NOT EDIT DIRECTLY. Edit the source document instead: src/content/docs/guides/deployment/azure-functions.mdx Then run: pnpm generate-language-pages */}
...
:::note
\*\* Azure Functions supports HTTP streaming responses in the v4 programming model. For production streaming, ensure your Function App plan supports long-running requests (Consumption plan has a 5-minute timeout; Premium or Dedicated plans are recommended for streaming workloads).
:::
