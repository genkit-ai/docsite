...
description: Announcing the preview launch of Genkit Dart. Build full-stack, AI-powered apps for any platform with Dart and Flutter, with model flexibility, type-safety, and a local Developer UI.
cover:
  alt: Genkit Dart
  image: ./_assets/announcing-genkit-dart/genkit-dart.webp
tags:
  - dart
  - flutter
  - announcements
...
import devUiImage from './_assets/announcing-genkit-dart/genkit-dart-devui.webp';
...
<Image src={devUiImage} alt="The Genkit Developer UI running the Trip Planner flow" />
