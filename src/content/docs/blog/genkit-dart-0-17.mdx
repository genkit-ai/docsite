...
Here is `asyncOrchestrator` running in the Genkit Developer UI, launching three `researcher` subagents in the background and synthesizing their results once they complete:
