...
date: 2026-09-21
authors: chris-gill
description: Genkit Dart 0.17 brings resumable generate calls and agent snapshots, background subagents, pluggable telemetry with genkit_otel, and a curated OpenAI model catalog.
cover:
