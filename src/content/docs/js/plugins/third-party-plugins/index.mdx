...
<CardGrid>
  ...
  <Card title="Pinecone">
    ...
    <br />
    <a href="/js/plugins/pinecone">View plugin info</a>
  </Card>
  <Card title="ChromaDB">
    ...
    <br />
    <a href="/js/plugins/chroma">View plugin info</a>
  </Card>
  <Card title="AuthO">
  ...
  <Card title="Ollama">
    ...
    <br />
    <a href="/js/plugins/ollama">View plugin info</a>
  </Card>
  <Card title="pgvector" icon="document">
    ...
    <br />
    <a href="/js/plugins/pgvector">View template</a>
  </Card>
  <Card title="Cloud SQL for PostgreSQL">
    ...
    cloud vector database.
    <br />
    <a href="/js/plugins/cloud-sql-pg">View plugin info</a>
  </Card>
  <Card title="MCP Toolbox For Databases">
    The MCP Toolbox plugin integrates the{' '}
    <a class="inline-flex no-underline" href="https://github.com/googleapis/genai-toolbox" target="_blank">
      MCP Toolbox tools
      <Icon name="external" />
    </a>{' '}
    into the Genkit framework. It enables you to develop tools easier, faster, and more securely by handling the
    complexities such as connection pooling, authentication, and more.
    <br />
    <a href="/js/plugins/toolbox">View template</a>
  </Card>
</CardGrid>
