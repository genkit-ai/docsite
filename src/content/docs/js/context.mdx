...
actions including [flows](/js/flows), [tools](/docs/tool-calling), and
[prompts](/js/dotprompt).
...
<Tabs>
  ...
  <TabItem label="Prompt file">
    When using [Dotprompt templates](/js/dotprompt), context is made available with the
