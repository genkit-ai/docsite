...
<h3 style="text-align: center;">Benefits of Genkit</h3>


<div class=" not-content flex flex-row items-center gap-[28px]" style="height: 283px; margin: 50px 0">
  <InfoCard title="Unified model interface" learnMoreUrl="/features/feature-two-details/" learnMoreText='Learn about model support'>
    Gemini
  </InfoCard>
  <InfoCard title="Building blocks for common AI use cases" learnMoreUrl="/features/feature-two-details/" learnMoreText='Learn the core concepts'>
    Powerful primitives to help you build agents, chatbots, and data-enhanced AI workflwos
  </InfoCard>
  <InfoCard title="Ready for web and mobile" learnMoreUrl="https://example.com/external-info" learnMoreText='Learn about deployment'>
...
<div class=" not-content flex flex-row items-center gap-[28px]" style="margin: 50px 0">
  <InfoCard title="Genkit by Example" learnMoreUrl="https://examples.genkit.dev/" learnMoreText='View Interactive Genkit code samples'>
  </InfoCard>
  <InfoCard title="Sample apps" learnMoreUrl="/features/feature-two-details/" learnMoreText='Learn the core concepts'>
  </InfoCard>
  <InfoCard title="?????" learnMoreUrl="https://example.com/external-info" learnMoreText='Learn about deployment'>
  </InfoCard>
</div>
