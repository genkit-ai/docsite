...
see the [Genkit Go documentation](/docs/genkit-go/get-started-go).
...
<table class="responsive key-functions">
  ...
  <tr>
    ...
    <td>Use streamlined APIs to build AI features with <a href="/docs/genkit/models#structured-output">
    structured output</a>, <a href="/docs/genkit/tool-calling">agentic tool calling</a>, <a href="/docs/genkit/rag">context-aware generation</a>, <a href="/docs/genkit/models#multimodal">multi-modal input/output</a>, and more. Genkit handles the complexity of AI development, so you can build and iterate faster.</td>
  </tr>
  <tr>
    <td><strong>Web and mobile ready</strong></td>
    <td>Integrate seamlessly with frameworks and platforms including Next.js, React, Angular, iOS, Android, using purpose-built <a href="/docs/functions/oncallgenkit">client SDKs</a> and helpers.</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>Accelerate AI development with a purpose-built, local <a href="/docs/genkit/devtools">CLI and Developer UI</a>. Test prompts and
...
* [Text and image generation](/docs/genkit/models)
* [Type-safe, structured data generation](/docs/genkit/models#structured-output)
* [Tool calling](/docs/genkit/tool-calling)
* [Prompt templating](/docs/genkit/dotprompt)
* [Persisted chat interfaces](/docs/genkit/chat)
* [AI workflows](/docs/genkit/flows)
* [AI-powered data retrieval (RAG)](/docs/genkit/rag)
...
Functions client SDKs](/docs/functions/oncallgenkit).
