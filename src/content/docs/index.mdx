...
response = await ai.generate(
	model=google_genai_name('imagen-3.0-generate-002'),
	prompt='a banana riding a bicycle'
)
...
<LanguageContent lang="python">
```python
# Anthropic models are available through Vertex AI Model Garden
from genkit.ai import Genkit
...
func main() {
	...
	resp, err := genkit.Generate(ctx, g,
		ai.WithPrompt("Why is Firebase awesome?"),
		ai.WithModelName("xai/grok-3-mini"),
	)
	if err != nil {
		log.Fatal(err)
	}
...
<LanguageContent lang="python">
```python
# xAI models through OpenAI-compatible interface
from genkit.ai import Genkit
from genkit.plugins.openai_compatible import OpenAICompatible
...
<LanguageContent lang="python">
```python
# DeepSeek models through OpenAI-compatible interface
from genkit.ai import Genkit
from genkit.plugins.openai_compatible import OpenAICompatible
...
<LanguageContent lang="python">
```python
# Ollama models through OpenAI-compatible interface
from genkit.ai import Genkit
from genkit.plugins.openai_compatible import OpenAICompatible
