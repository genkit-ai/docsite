...
- Learn about [developer tools](/unified-docs/developer-tools) for more ways to work with Genkit locally
- Explore [creating flows](/unified-docs/creating-flows) to build flows that can be accessed through the MCP server
