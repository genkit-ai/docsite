...
- See [writing embedder plugins](/unified-docs/plugin-authoring/embedders) for custom embedding models
- Check out [telemetry plugins](/unified-docs/plugin-authoring/telemetry) for monitoring and observability
