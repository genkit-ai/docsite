...
<Tabs syncKey="setup">
  <TabItem label="Google Cloud Console" icon="seti:settings">
  ...
  <TabItem label="gcloud CLI" icon="seti:terminal">
    ```bash
...
<Tabs syncKey="platform">
  <TabItem label="Cloud Functions" icon="seti:firebase">
  ...
  <TabItem label="Cloud Run" icon="seti:docker">
  ...
  <TabItem label="Compute Engine" icon="seti:gear">
...
<Tabs syncKey="js-auth">
  <TabItem label="Environment Variables" icon="seti:javascript">
    ```bash
  ...
  <TabItem label="Programmatic" icon="seti:javascript">
    ```ts
    import { enableFirebaseTelemetry } from '@genkit-ai/firebase';
...
<Tabs syncKey="go-auth">
  <TabItem label="Environment Variables" icon="seti:go">
    ```bash
    export GOOGLE_APPLICATION_CREDENTIALS="/path/to/key.json"
    export GOOGLE_CLOUD_PROJECT="your-project-id"
    ```
  ...
  <TabItem label="Programmatic" icon="seti:go">
    ```go
    import (
...
<Tabs syncKey="python-auth">
  <TabItem label="Environment Variables" icon="seti:python">
    ```bash
    export GOOGLE_APPLICATION_CREDENTIALS="/path/to/key.json"
    export GOOGLE_CLOUD_PROJECT="your-project-id"
    ```
  ...
  <TabItem label="Programmatic" icon="seti:python">
    ```python
    from genkit.ai import Genkit
    from genkit.monitoring import enable_firebase_monitoring
