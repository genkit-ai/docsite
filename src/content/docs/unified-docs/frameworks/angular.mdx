...
- Familiarity with [Angular](https://angular.dev/) and [Genkit flows](/unified-docs/flows)
...
- Learn about [client access patterns](/unified-docs/client) for advanced integration
