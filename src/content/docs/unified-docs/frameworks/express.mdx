...
- **Go**: [Gin](/unified-docs/frameworks/gin) or standard `net/http`
- **Python**: [Flask](/unified-docs/frameworks/flask) or [FastAPI](/unified-docs/frameworks/fastapi)
:::
...
- Explore [authentication patterns](/unified-docs/auth) for securing your applications
- See [deployment guides](/unified-docs/deployment) for production deployment strategies
- Check out other framework integrations:
  - [Next.js](/unified-docs/frameworks/nextjs) for React applications
  - [Gin](/unified-docs/frameworks/gin) for Go applications
  - [Flask](/unified-docs/frameworks/flask) for Python applications
