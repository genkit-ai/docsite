...
- **Go**: [Gin](/unified-docs/frameworks/gin) with React frontend
- **Python**: [FastAPI](/unified-docs/frameworks/fastapi) with React frontend
:::
...
- Check out other framework integrations:
  - [Express.js](/unified-docs/frameworks/express) for API-first applications
