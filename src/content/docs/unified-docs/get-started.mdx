...
:::note
Genkit also supports models from Vertex AI, Anthropic, OpenAI, Cohere, Ollama, and more. See [generating content](/unified-docs/models) for details.
:::
...
:::note
The command after `--` should run the file that defines or imports your Genkit components. You can use `tsx`, `node`, or other commands based on your setup. Learn more in [developer tools](/unified-docs/devtools).
:::
...
- [Developer tools](/unified-docs/devtools): Set up your local workflow with the Genkit CLI and Dev UI.
- [Generating content](/unified-docs/models): Use Genkit's unified generation API to work with multimodal and structured output across supported models.
- [Creating flows](/unified-docs/flows): Learn about streaming flows, schema customization, deployment options, and more.
