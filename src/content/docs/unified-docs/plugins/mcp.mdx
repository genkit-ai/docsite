...
- Learn about [tool calling](/unified-docs/tool-calling) to understand how MCP tools integrate with Genkit
- Explore [creating flows](/unified-docs/flows) to build workflows that leverage MCP capabilities
