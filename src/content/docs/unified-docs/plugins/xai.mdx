...
- Explore [tool calling](/unified-docs/tool-calling) to add interactive capabilities to your Grok applications
- See [creating flows](/unified-docs/creating-flows) to build structured AI workflows with real-time information
