...
![MCP Database Toolbox Architecture](../../../../assets/plugins/assets/mcp_db_toolbox.png)
...
- Learn about [MCP (Model Context Protocol)](/unified-docs/model-context-protocol) for understanding the underlying protocol
- Explore [tool calling](/unified-docs/tool-calling) patterns in Genkit
- See [authorization patterns](/unified-docs/deployment/authorization) for securing your tools
- Check out [observability](/unified-docs/observability-monitoring) for monitoring tool usage
</LanguageContent>
...
- Implementing custom MCP servers using the [Model Context Protocol](/unified-docs/model-context-protocol)
- Building database tools using your language's native database drivers

See the [tool calling guide](/unified-docs/tool-calling) for examples of creating custom database tools in your preferred language.
</LanguageContent>