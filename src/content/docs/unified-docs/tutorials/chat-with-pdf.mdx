...
:::note
Genkit supports many model providers including Vertex AI, Anthropic, OpenAI, and Ollama. See [AI providers](/unified-docs/plugins/overview) for more options.
:::
...
- Learn about [RAG (Retrieval-Augmented Generation)](/unified-docs/rag) for more sophisticated document processing
- Explore [tool calling](/unified-docs/tool-calling) to add external capabilities
- Try [different AI providers](/unified-docs/plugins/overview) for varied model capabilities
