...
- Explore [pgvector plugin](/unified-docs/vector-databases/pgvector) for more advanced features
- Review [evaluation strategies](/unified-docs/evaluation) for measuring retrieval quality
- Set up [observability](/unified-docs/local-observability) for monitoring retrieval performance
